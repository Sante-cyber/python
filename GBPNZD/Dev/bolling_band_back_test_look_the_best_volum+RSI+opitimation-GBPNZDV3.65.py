              ...
              if i>1:
                ...
                if i<len(df)-1:
                    ...
                    if trade==True:
                        ...
                        elif is_trade==4.21 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price:
                                sl=order_price-0.006*order_price
                                tp=order_price+0.005*order_price 
                        ...
                        elif is_trade==4.22 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price:
                                if pre_row.sd>0.01:
                                    sl=order_price-0.01*order_price
                        ...
                        elif is_trade==4.23 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price:
                                if pre_row.sd>0.01:
                                    sl=order_price-0.01*order_price
                        ...
                        elif is_trade==4.323 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price:
                                if pre_row.sd>0.01:
                                    sl=order_price-0.01*order_price
                        ...
                        elif is_trade==4.331 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price:
                                if pre_row.sd>0.01:
                                    sl=order_price-0.01*order_price
                        ...
                        elif is_trade==4.332 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.low<=order_price :
                                if pre_row.sd>0.01:
                                    sl=order_price-0.01*order_price
