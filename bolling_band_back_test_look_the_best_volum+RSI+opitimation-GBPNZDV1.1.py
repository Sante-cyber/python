                ...
                if i<len(df)-1:
                    ...
                    if trade==True:
                        ...
                        if is_trade==1.1 and self.trading_allowed():
                          ...
                          elif pre_row.high_rsi<min(pre_row.rsi,pre_row.low_rsi) and pre_row.low_rsi<30 and data.low_rsi>pre_row.low_rsi and data.high_rsi>pre_row.high_rsi and data.low_rsi>30 and data.high_rsi>30:
                                order_price=data.close
                                if next_row.low<=order_price:
                                    sl=order_price-2*data.sd
                                    tp=order_price+2*data.sd
                          ...
                          elif pre_row.high_rsi<30 and data.rsi>max(data.low_rsi,data.high_rsi):
                                order_price=data.close
                                if next_row.low<=order_price:
                                    sl=order_price-2*data.sd
                                    tp=order_price+2*data.sd
