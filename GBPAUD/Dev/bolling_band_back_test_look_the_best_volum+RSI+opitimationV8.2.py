                    ...
                    if trade==True:
                        ...
                        if is_trade==1.1   and self.trading_allowed():
                          ...
                          if pre_row.sell_cnt>0 and data.sell_cnt==0 and pre_row.rsi<80 and pre_row.high_rsi>80:
                            ...
                            elif pre_row.low_rsi<pre_row.high_rsi and data.high_rsi<70 and pre_row.high_rsi>70 and data.low_rsi<70:                         
                                order_price=data.close
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
                            ...
                            elif  pre_row.low_rsi>max(pre_row.rsi,pre_row.high_rsi) and pre_row.high_rsi>data.high_rsi and pre_row.low_rsi>data.low_rsi and pre_row.high_point!=1 and pre_row.low_point!=1:
                                order_price=data.close
                                if next_row.high>=order_price:
                                    # sl=order_price+2*data.sd
                                    # tp=order_price-2*data.sd
...
#  datetime.now()
        ...
        df.to_csv(f'C:/c/EA/bollinger-bands/H4_year/b_{year}_opi_8.2.csv')
        ...
        df.to_csv(f'C:/c/EA/bollinger-bands/H4_year/b_{year}_opi_result_8.2.csv',index=False)
...
df1.to_csv(f'C:/c/EA/bollinger-bands/H4_year/result_detail_volumn_rsi_opi_8.2.csv')
df2.to_csv(f'C:/c/EA/bollinger-bands/H4_year/final_result_volumn_detail_rsi_opi_8.2.csv')
