                    ...
                    if trade==True:
                        ...
                        if is_trade==1.1  and self.trading_allowed():
                            ...
                            if  pre_row.buy_cnt==2 and data.buy_cnt==0 \
                                ...
                                # and pre_row.lower_30==0 and abs((pre_row.close-pre_row.open)/pre_row.close)>=0.001:
                                  ...
                                  is_trade=3.2
                                  trade_signal='sell'   
                        elif is_trade==1.36 and self.trading_allowed():
                            if pre_row.lower_30>0 and pre_row.lower_30>pre_row.lower_30_high and pre_row.lower_30_low==0 and pre_2_row.lower_30_low>0 and\
                                ...
                                if next_row.low<=order_price:
                                  ...
                                  is_trade=3.3
                                  trade_signal='sell'
                        elif is_trade==1.363 and self.trading_allowed():
                            ...
                            if pre_row.lower_30_high>0 and data.lower_30_high==0\
                                ...
                                is_trade=3.4
                                trade_signal='sell'
                        elif is_trade==1.364 and self.trading_allowed():
                        ...
                        #modify 2025-04-01#
                            ...
                            if   pre_row.high_rsi>70 and data.high_rsi>70  and (pre_row.high_point>0 or pre_row.low_point>0)\
                                  and  pre_row.sd>0.004 and abs(data.low_rsi-data.high_rsi)/data.low_rsi>0.0025:
                                order_price=data.close
                            ...
                            if pre_row.over_70>=2 and pre_row.over_70<=3 and data.over_70==0 and abs((data.close-data.open)/data.close)<0.00001:
                                ...
                                if next_row.high>=order_price:
                                    ...
                                    if track_order==0:
                                       sl=order_price+0.1*order_price
                                    # modify-2025-02-19 start
                                    if (order_price-tp)/order_price>0.01:
                                       tp=order_price-0.01*order_price 
                                    # modify-2025-02-19 end
                                    is_trade=2.23
                                    self.add_position(position(next_row.time,order_price,trade_signal,self.volume,sl,tp,currency,is_trade))
                            ...
                            if  data.sell_cnt==0 and data.over_70_low==0 and data.over_70==0 and pre_2_row.sell_cnt==2 and pre_row.sell_cnt==0 \
                             ...
                             if data.low_rsi>data.high_rsi and data.rsi>data.low_rsi:
                                ...
                                if next_row.high>=order_price:
                                 ...
                                 is_trade=0  
                        elif is_trade==2.37 and self.trading_allowed():
                            # print(data.time)
                            ...
                            elif pre_row.over_70>0 and data.over_70==0 and pre_row.low_rsi>70  and pre_row.low_rsi<78 and pre_row.high_rsi>70 and pre_row.low_rsi>pre_row.high_rsi:
                                order_price=data.close
                                if next_row.high>=order_price:
