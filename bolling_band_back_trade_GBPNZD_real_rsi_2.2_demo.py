...
log_path=os.getcwd()
file_path = os.path.join(log_path, 'make_order_gbp_nzd_demo.csv')
        ...
        if positions <= 1 and trade_strategy == 0:
            ...
            if trade_strategy > 0:
                ...
                if pre_trade_strategy > 0:
                    ...
                    action_time=make_order['action_time'].iloc[-1]
        ...
        if trade_strategy > 0 and last_order_date != tick_date:
            ...
            if action is not None:
                ...
                if action_time is None:
                    ...
                    make_order['action_time']=order_time
