                    ...
                    if not pre_row.empty :
                        ...
                        #     trade_signal='sell'
                            ...
                            trade_signal='sell'
                                ...
                                and pre_row.signal=='sell' and pre_row.sell_cnt==1 and pre_row.over_70==1 and pre_row.low_rsi<min(pre_row.high_rsi,pre_row.rsi) and data.low_rsi<min(data.high_rsi,data.rsi)\
                        ...
                        if is_trade==1.1   and self.trading_allowed():
                            ...
                            # print(f'{data}--{next_row}')
                              ...
                              is_trade=0
                                ...
                                is_trade=0
                        elif is_trade==2.21 and  self.trading_allowed():
                            order_price=data.close
                            if next_row.high>=order_price:
                            # print(f'{data}--{next_row}')
                                sl=order_price+1*data.sd
