                    ...
                    if trade==True:
                        ...
                        if is_trade==1.1 and self.trading_allowed():
                          if pre_row.high_rsi>30 and pre_row.high_rsi>pre_row.low_rsi and pre_row.low_rsi>pre_row.rsi:
                            ...
                            if pre_row.over_70>0 and data.over_70==0 and pre_row.rsi>max(pre_row.high_rsi,pre_row.low_rsi):
                                order_price=data.close 
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
                            ...
                            elif pre_row.over_70>0 and data.over_70==0 and pre_row.rsi<min(pre_row.high_rsi,pre_row.low_rsi) and data.high_rsi>max(data.rsi,data.low_rsi):
                                order_price=data.close 
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
