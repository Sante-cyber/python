                ...
                if i<len(df)-1:
                    ...
                    if trade==True:
                        ...
                        if is_trade==1.1 and self.trading_allowed():
                          if pre_row.high_rsi>30 and pre_row.high_rsi>pre_row.low_rsi and pre_row.low_rsi>pre_row.rsi:
                          ...
                          elif pre_row.high_rsi>30 and pre_row.high_rsi>pre_row.low_rsi and pre_row.low_rsi<data.low_rsi:
                                order_price=data.close
                                if next_row.low<=order_price:
                              ...
                              trade_signal='sell'
                                ...
                                and data.rsi>max(data.low_rsi,data.high_rsi) and data.high_rsi<30 and data.lower_30_low>=data.lower_30_high :
                                order_price=data.close
                                if next_row.low<=order_price:
                                    sl=order_price-2*data.sd
                                    tp=order_price+2*data.sd
                                ...
                                and data.rsi>max(data.low_rsi,data.high_rsi) and data.high_rsi>30 and data.high_rsi>data.low_rsi and data.low_rsi>pre_row.low_rsi:
                                order_price=data.close
                                if next_row.low<=order_price:
                                    sl=order_price-2*data.sd
                                    tp=order_price+2*data.sd
                          ...
                          elif pre_row.high_rsi<30 and pre_row.low_rsi<min(pre_row.rsi,pre_row.high_rsi) and data.low_rsi<min(data.rsi,data.high_rsi) and data.low_rsi>30:
                                order_price=data.close
                                if next_row.low<=order_price:
                                    sl=order_price-2*data.sd
                                    tp=order_price+2*data.sd
                            ...
                            elif  pre_row.rsi<72 and data.low_rsi<pre_row.rsi and  data.sd>=0.008:
                                order_price=data.close 
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
                            ...
                            # modify-20250210
                            elif  pre_row.rsi<72 and data.low_rsi<pre_row.rsi and  data.sd<0.008 and pre_row.low_rsi<60:
                                order_price=data.close 
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
                            ...
                            if  pre_row.over_70>0 and data.over_70==0 and pre_row.high_rsi>max(pre_row.low_rsi,pre_row.rsi) \
                                ...
                                if next_row.high>=order_price:
                                    ...
                                    if (order_price-tp)/order_price>0.007:
                                        tp=order_price-0.007*order_price  
                                    if (sl-order_price)/order_price>0.007:
                                        sl=order_price+0.007*order_price
                                    # if track_order==0:
                                    #     sl=order_price+0.1*order_price
                                    if track_order==0:
                            ...
                            if pre_row.low_rsi>max(pre_row.rsi,pre_row.high_rsi) and data.low_rsi<pre_row.low_rsi :
                                ...
                                if next_row.high>=order_price:
                                    ...
                                    trade_signal='buy'
                            # modify-20250210
                            elif pre_row.rsi>=69 and pre_row.low_rsi<min(pre_row.rsi,pre_row.high_rsi) and data.high_rsi>70 and pre_row.high_rsi>70 and data.close<data.ub and data.low_rsi<70:
                                order_price=data.close 
                                if next_row.high>=order_price:
                                    sl=order_price+2*data.sd
                                    tp=order_price-2*data.sd
                            ...
                            elif pre_row.rsi<69 and pre_row.low_rsi<min(pre_row.rsi,pre_row.high_rsi) and data.high_rsi>70 and pre_row.high_rsi>70 and data.high_rsi>pre_row.high_rsi and data.close<data.ub and data.low_rsi<70:
                                order_price=data.close 
                                if next_row.high>=order_price:
                        ...
                        elif is_trade==3.141 and self.trading_allowed():
                            order_price=pre_row.close
                            if data.high>=order_price:
                                if pre_row.sd>0.009:
                                    sl=order_price+0.008*order_price
