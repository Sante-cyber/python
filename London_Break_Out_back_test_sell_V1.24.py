...
for i in forecast_month_list:
    ...
    df['target'] = (df['target_rsi'] < 30).astype(int)
...
"tick_volume"
    ...
    model_path=f'C:/c/EA/London_break_out/model/best_model_LSGM_{forcast_month}_sell.pkl'
    ...
    feature_importances=pd.concat([feature_importances,top_features],ignore_index=True)
...
best_param_total.to_csv('C:/c/EA/London_break_out/model/best_param_sell.csv')
df_forecast.to_csv('C:/c/EA/London_break_out/model/forecast_result_sell.csv')
report_df.to_csv('C:/c/EA/London_break_out/model/model_test_sell.csv')
feature_importances.to_csv('C:/c/EA/London_break_out/model/model_feature_importance1.csv')
